...
```{r}
#p1 <- DimPlot(all_data.combined, reduction="tsne", group.by = "atlas_predicted_clusters", split.by = "orig.ident") 
...
table(all_data.combined@meta.data$seurat_clusters, object@meta.data$orig.ident)
